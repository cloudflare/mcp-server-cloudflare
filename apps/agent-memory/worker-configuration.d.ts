/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 980665b828b254c0827b8305788366ad)
// Runtime types generated with workerd@1.20260529.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_METRICS: AnalyticsEngineDataset;
	ENVIRONMENT: "staging" | "production" | "development";
	MCP_SERVER_NAME: "agent-memory-staging" | "agent-memory" | "<PLACEHOLDER>";
	MCP_SERVER_VERSION: "0.1.0" | "<PLACEHOLDER>";
	AGENT_MEMORY_BUCKET_NAME: "agent-memory-mcp";
	MCP_OBJECT: DurableObjectNamespace<import("./src/agent-memory.app").AgentMemoryMCP>;
	MEMORY_INDEX: DurableObjectNamespace<import("./src/agent-memory.app").MemoryIndex>;
	CLOUDFLARE_CLIENT_ID?: "<PLACEHOLDER>";
	CLOUDFLARE_CLIENT_SECRET?: "<PLACEHOLDER>";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/agent-memory.app");
		durableNamespaces: "AgentMemoryMCP" | "MemoryIndex";
	}
	interface StagingEnv {
		OAUTH_KV: KVNamespace;
		MCP_METRICS: AnalyticsEngineDataset;
		ENVIRONMENT: "staging";
		MCP_SERVER_NAME: "agent-memory-staging";
