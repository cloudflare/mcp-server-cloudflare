// Generated by Wrangler by running `wrangler types` (hash: 7bbb6e621dc9d0d31e927ce110ac40d3)
...
declare namespace Cloudflare {
	interface Env {
		...
		MCP_OBJECT: DurableObjectNamespace<import("./src/dns-records.app").DNSRecordsMCP>;
		USER_DETAILS: DurableObjectNamespace<import("./src/dns-records.app").UserDetails>;
