...
| [**Agent Memory server**](/apps/agent-memory)                  | Persistent, searchable memory for agents backed by your own R2 and Workers AI                   | `https://memory.mcp.cloudflare.com/mcp`        |
